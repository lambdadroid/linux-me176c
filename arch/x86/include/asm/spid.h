...
enum {
	...
	INTEL_MRFL_PHONE_ATC_PRO = 0x0006,
	INTEL_MRFL_PHONE_ATC_ENG = 0x8006,
	INTEL_MRFL_PHONE_SHA_PRO = 0x0007,
	INTEL_MRFL_PHONE_SHA_ENG = 0x8007,
	INTEL_MRFL_PHONE_MRS_PRO = 0x0008,
	INTEL_MRFL_PHONE_MRS_ENG = 0x8008,
	INTEL_MRFL_PHONE_SKLY_PRO = 0x0009,
	INTEL_MRFL_PHONE_SKLY_ENG = 0x8009,
	INTEL_MRFL_PHONE_SPL_PRO = 0x000A,
	INTEL_MRFL_PHONE_SPL_ENG = 0x800A,
...
enum {
	...
	MRFL_PHONE_RBY_20 = 0x0020,
	MRFL_PHONE_RBY_25 = 0x0025,
	MRFL_PHONE_RBY_26 = 0x0026,
	MRFL_PHONE_RBY_3 = 0x0030,
...
enum {
	...
	MRFL_PHONE_MVN_3 = 0x0120,
	MRFL_PHONE_MVN_4 = 0x0130,
...
enum {
	...
	MRFL_PHONE_GLC_2 = 0x0010,
	MRFL_PHONE_GLC_3 = 0x0020,
	MRFL_PHONE_GLC_4 = 0x0030,
	MRFL_PHONE_GLC_UNKNOWN = 0xFFFF
};

/* Hardware_ID table for Product_Line_ID == INTEL_MRFL_PHONE_ATC */
enum {
	MRFL_PHONE_ATC_0 = 0x0000,
	MRFL_PHONE_ATC_1 = 0x0001,
	MRFL_PHONE_ATC_2 = 0x0010,
	MRFL_PHONE_ATC_3 = 0x0020,
	MRFL_PHONE_ATC_4 = 0x0030,
	MRFL_PHONE_ATC_UNKNOWN = 0xFFFF
};

/* Hardware_ID table for Product_Line_ID == INTEL_MRFL_PHONE_SHA */
enum {
	MRFL_PHONE_SHA_0 = 0x0000,
	MRFL_PHONE_SHA_1 = 0x0001,
	MRFL_PHONE_SHA_2 = 0x0010,
	MRFL_PHONE_SHA_3 = 0x0020,
	MRFL_PHONE_SHA_4 = 0x0030,
	MRFL_PHONE_SHA_UNKNOWN = 0xFFFF
};

/* Hardware_ID table for Product_Line_ID == INTEL_MRFL_PHONE_MRS */
enum {
	MRFL_PHONE_MRS_0 = 0x0000,
	MRFL_PHONE_MRS_UNKNOWN = 0xFFFF
};

/* Hardware_ID table for Product_Line_ID == INTEL_MRFL_PHONE_SKLY */
enum {
	MRFL_PHONE_SKLY_0 = 0x0000,
	MRFL_PHONE_SKLY_UNKNOWN = 0xFFFF
};

/* Hardware_ID table for Product_Line_ID == INTEL_MRFL_PHONE_SPL */
enum {
	MRFL_PHONE_SPL_0 = 0x0000,
	MRFL_PHONE_SPL_1 = 0x0001,
	MRFL_PHONE_SPL_2 = 0x0010,
	MRFL_PHONE_SPL_3 = 0x0020,
	MRFL_PHONE_SPL_4 = 0x0030,
	MRFL_PHONE_SPL_UNKNOWN = 0xFFFF
};
...
#define INTEL_MID_BOARD_CDP_ALL() ( \
		INTEL_MID_BOARD(2, PHONE, MRFL, RBY, PRO) || \
		...
		INTEL_MID_BOARD(2, PHONE, MRFL, SKLY, PRO) || \
		INTEL_MID_BOARD(2, PHONE, MRFL, SKLY, ENG) || \
