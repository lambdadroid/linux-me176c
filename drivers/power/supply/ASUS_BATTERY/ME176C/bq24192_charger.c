...
static void otg_worker(struct work_struct *work)
{
	...
	gpio_data = gpio_get_value(360); // TODO: Stop hardcoding
...
inline unsigned int query_cable_status(void) { return 900; }
...
inline int cable_status_register_client(struct notifier_block *nb) {return 0;}
inline int cable_status_unregister_client(struct notifier_block *nb) {return 0;}
